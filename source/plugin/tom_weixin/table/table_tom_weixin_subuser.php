...
class table_tom_weixin_subuser extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_weixin_subuser';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_by_openid($openid,$field='*') {
		return DB::fetch_first("SELECT $field FROM %t WHERE open_id=%s", array($this->_table, $openid));
	}
