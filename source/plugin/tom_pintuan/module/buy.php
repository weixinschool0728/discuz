...
$access_token = $weixinClass->get_access_token();
 file_put_contents("./upload/userinfo.txt",$__UserInfo,FILE_APPEND);
if(!empty($__UserInfo['openid']) && !empty($access_token)){
    ...
    file_put_contents("./upload/userinfo.txt",$get_user_info_url,FILE_APPEND);
    $return = get_html($get_user_info_url);
    file_put_contents("./upload/userinfo.txt",  print_r($return,TRUE),FILE_APPEND);
    if(!empty($return)){
